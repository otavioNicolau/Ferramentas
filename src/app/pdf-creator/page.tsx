    ...
    >
      <div className="space-y-6">
        <div className="text-center py-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">PDF Creator</h3>
          <p className="text-gray-600 mb-8">Crie documentos PDF do zero com texto, imagens e formatação</p>
